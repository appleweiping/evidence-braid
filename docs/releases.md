...
Versioned Evidence Braid source distributions and wheels are published on the repository's
[GitHub Releases](https://github.com/appleweiping/evidence-braid/releases) page. The project is not
...
```bash
gh release download v0.3.0 --repo appleweiping/evidence-braid --dir evidence-braid-v0.3.0
cd evidence-braid-v0.3.0
sha256sum --check SHA256SUMS
gh attestation verify ./*.whl --repo appleweiping/evidence-braid
gh attestation verify ./*.tar.gz --repo appleweiping/evidence-braid
```
